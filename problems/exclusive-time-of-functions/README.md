...
Return _the **exclusive time** of each function in an array, where the value at the <code>i<sup>th</sup></code> index represents the exclusive time for the function with ID `i`_.
